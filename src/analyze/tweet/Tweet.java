...
public class Tweet {
	...
	/**
	 * Removes all duplicates from the list. Maintains original order 
	 * keeping the first occurrence and discarding the rest
	 * @param list A list - does not need to be sorted
